...
const EditProductCardAdmin = ({productDetail}) => {
  ...
  const initialData = {
    ...
    image:productDetail.image , // store File objects
    ...
    more_detail: productDetail.more_detail || {},
  };
  ...
  return (
    <div className='fixed inset-0 h-full bg-black/80 flex justify-center items-center' >
        <div className="bg-white w-full max-w-4xl max-h-[78vh] overflow-y-auto rounded shadow-lg mt-20">
...
export default EditProductCardAdmin